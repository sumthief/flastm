...
module.exports = {
    ...
    addTags: (artist, album, tags, sk) => fetch({...defaultParams, action: 'addTags', artist, album, sk, tags, sign: true, method: 'post'}),
    removeTag: (artist, album, tag, sk) => fetch({...defaultParams, action: 'removeTag', artist, album, sk, tag, sign: true, method: 'post'})
};
